...
@PageTitle("Tarifa")
@Route(value = "/tarifa", layout = menu.class)
@CssImport("./styles/styles.css")
public class menuFeeEntityView extends VerticalLayout {

    HorizontalLayout centerDiv;
    Button b1, b2, b3, b4;
    private AccessAnnotationChecker accessChecker;

    public menuFeeEntityView(AccessAnnotationChecker aChecker) {
        ...
        b1.setId("b1");
        b1.addClickListener(e -> UI.getCurrent().navigate("/creartarifa"));

        b2 = new Button("MODIFICAR");
        b2.addClassName("buttonsX");
        b2.setId("b2");
        b2.addClickListener(e -> UI.getCurrent().navigate("/modificartarifa"));

        b3 = new Button("ELIMINAR");
        b3.addClassName("buttonsX");
        b3.setId("b3");
        b3.addClickListener(e -> UI.getCurrent().navigate("/eliminartarifa"));

        b4 = new Button("CONSULTAR DATOS");
        b4.addClassName("buttonsX");
        b4.setId("b4");
        b4.addClickListener(e -> UI.getCurrent().navigate("/consultartarifas"));
