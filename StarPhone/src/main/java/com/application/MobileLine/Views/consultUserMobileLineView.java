...
public class consultUserMobileLineView extends VerticalLayout {
    ...
    public consultUserMobileLineView(AuthenticatedUser authUser, MobileLineService mService, ContractService cService) {
